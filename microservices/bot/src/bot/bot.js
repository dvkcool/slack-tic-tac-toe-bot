...
class Bot {
    ...
    respondToStartMessages() {
        ...
        let startMessages = messages
            ...
            .map(e => {
                if (MsgHelper.containsWord(e.text, 'boys')) {
                    this.gameType = GameTypeEnum.BOYS;
                } else if (MsgHelper.containsWord(e.text, 'girls')) {
                    this.gameType = GameTypeEnum.GIRLS;
                } else if (MsgHelper.containsWord(e.text, 'food')) {
    ...
    startGame(messages, channel, players) {
        ...
        let game = new Game(this.slack, messages, channel, players, this.gameType);
